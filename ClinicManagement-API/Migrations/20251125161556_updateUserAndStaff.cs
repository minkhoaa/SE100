...
{
    /// <inheritdoc />
    public partial class updateUserAndStaff : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
                    DefaultDurationMin = table.Column<short>(type: "smallint", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StaffUser", x => x.UserId);
                    table.ForeignKey(
                        name: "FK_StaffUser_Clinics_ClinicId",
                        column: x => x.ClinicId,
                        principalTable: "Clinics",
                        principalColumn: "ClinicId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StartTime = table.Column<TimeSpan>(type: "time(0) without time zone", nullable: false),
                    EndTime = table.Column<TimeSpan>(type: "time(0) without time zone", nullable: false),
                    SlotSizeMin = table.Column<short>(type: "smallint", nullable: false, defaultValue: (short)30),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TimeOffId = table.Column<Guid>(type: "uuid", nullable: false),
                    ClinicId = table.Column<Guid>(type: "uuid", nullable: false),
                    DoctorId = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DoctorTimeOff_Clinics_ClinicId",
                        column: x => x.ClinicId,
                        principalTable: "Clinics",
                        principalColumn: "ClinicId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DoctorTimeOff_Doctors_DoctorId",
                        column: x => x.DoctorId,
                        principalTable: "Doctors",
                        principalColumn: "DoctorId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Channel = table.Column<byte>(type: "smallint", maxLength: 10, nullable: false, defaultValue: (byte)1),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StartAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    EndAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    Source = table.Column<string>(type: "character varying(30)", maxLength: 30, nullable: false, defaultValue: "Web"),
                    ContactFullName = table.Column<string>(type: "character varying(150)", maxLength: 150, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DoctorTimeOff_ClinicId",
                table: "DoctorTimeOff",
                column: "ClinicId");
